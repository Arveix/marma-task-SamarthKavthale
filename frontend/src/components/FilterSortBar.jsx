            ...
            <div className="border-b border-gray-300 pb-3">
                ...
                {isOpen && (
                    <div className="mt-3 space-y-2">
                        <button aria-label="Unselect all" className="text-gray-300 w-full text-left underline" onClick={unselectAll}>Unselect all</button>
                        {options.map((option) => (
                            <label
                                key={option}
...
function FilterSortBar() {
    ...
    return (
        <>
            <div className="border-y-1 border-gray-300 grid grid-cols-2 items-center text-center font-bold lg:text-sm lg:flex lg:justify-between">
                ...
                <aside className={`fixed top-0 left-0 z-50 h-full bg-white w-full sm:w-80 ${isFilterOpen ? 'block' : 'hidden'} lg:sticky lg:w-64`}
                >
                    {/* Mobile header */}
